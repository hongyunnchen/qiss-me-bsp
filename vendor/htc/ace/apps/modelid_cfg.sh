...
cat /proc/cmdline | egrep -q '(PD9812000)|(PD9814000)'
      if [ $? = 0 ];
         then
#			mv /system/etc/nam/default.acdb /system/etc/firmware
#			mv /system/etc/nam/default_org.acdb /system/etc/firmware
#		    mv /system/etc/nam/CodecDSPID_MCLK.txt /system/etc
            mv /system/etc/nam/CodecDSPID.txt /system/etc
#           mv /system/etc/nam/media_profiles.xml /system/etc
			rm -f /system/build.prop
			mv /system/etc/nam/build.prop /system
			mv /system/etc/nam/*MCLK.txt /system/etc/soundimage/
#           mv /system/etc/nam/AdieHWCodec.csv /system/etc
#			mv /system/etc/nam/AIC3254_REG_DualMic.csv /system/etc
