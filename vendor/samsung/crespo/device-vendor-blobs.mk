...
PRODUCT_COPY_FILES += \
    ...
    vendor/samsung/crespo/proprietary/libdrmwvmplugin.so:system/vendor/lib/drm/libdrmwvmplugin.so \
    vendor/samsung/crespo/proprietary/libwvdrm_L3.so:system/vendor/lib/libwvdrm_L3.so \
    vendor/samsung/crespo/proprietary/libWVStreamControlAPI_L3.so:system/vendor/lib/libWVStreamControlAPI_L3.so \
    vendor/samsung/crespo/proprietary/libakm.so:system/vendor/lib/libakm.so \
    vendor/samsung/crespo/proprietary/libwvm.so:system/vendor/lib/libwvm.so
