...
/* { Added by Jerry.Qian, fix the rule of routing streams, 2012/09/19 */
#else
...
/* Added by Jerry.Qian, fix the rule of routing streams, 2012/09/19 } */
        ...
        // routing
        /* { Modefied by Jerry.Qian, must be updated if handleNotificationRoutingForStream(stream) changed, 2012/09/03 */
