...
static int responseSimStatus(Parcel &p, void *response, size_t responselen) {
    ...
    if (responselen == sizeof (RIL_CardStatus_v6)) {
    ...
    } /* Tina.Tang, 2012/01/20, fix SIM unlock and change SIM PIN can't work { */
      ...
      /* Tina.Tang, 2012/01/20, fix SIM unlock and change SIM PIN can't work } */
        ...
        ALOGE("responseSimStatus: A RilCardStatus_v6 or _v5 expected; length %d is not multiple of %d\n",
