...
private:
    ...
    */
    ...
    android::Mutex mFrameThreadWaitLock;
    ...
    android::Mutex mVideoThreadWaitLock;
    ...
    android::Mutex mShutterLock;

    bool mSnapshotThreadRunning;
    android::Mutex mSnapshotThreadWaitLock;
    Condition mSnapshotThreadWait;
    friend void *snapshot_thread(void *user);
    void runSnapshotThread(void *data);
    android::Mutex mRawPictureHeapLock;
    bool mInSnapshotMode;
    bool mJpegThreadRunning;
    android::Mutex mJpegThreadWaitLock;
    Condition mJpegThreadWait;
    android::Mutex mInSnapshotModeWaitLock;
    ...
    android::Mutex mLock;
    android::Mutex mCamframeTimeoutLock;
    ...
    android::Mutex mRecordLock;
    android::Mutex mRecordFrameLock;
    ...
    */
    ...
    android::Mutex mAutoFocusThreadLock;
    int mAutoFocusFd;

    android::Mutex mAfLock;
