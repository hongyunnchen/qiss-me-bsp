...
/* { Added by Jerry.Qian, save the created clients to destroy, 2012/05/22 */
static struct CLIENT *_clnt_alt;
/* Added by Jerry.Qian, save the created clients to destroy, 2012/05/22 } */
...
void cleanup_gps_rpc_clients() 
{
    ...
    /* { Modefied by Jerry.Qian, destroy the clients by a right order, 2012/05/22 */
    clnt_destroy(_clnt_alt);
    clnt_destroy(_clnt);
