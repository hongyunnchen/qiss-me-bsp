...
# copy hostapd
PRODUCT_COPY_FILES += \
	device/samsung/aries-common/hostapd:system/bin/hostapd  \
	device/samsung/aries-common/hostapd_cli:system/bin/hostapd_cli
...
PRODUCT_COPY_FILES += \
	...
	device/samsung/aries-common/update_bootimg.sh:update_bootimg.sh
	
#Brian copy all others kernel modules under the "modules" directory to system/lib/modules
PRODUCT_COPY_FILES += $(shell test -d device/samsung/aries-common/modules && \
	find device/samsung/aries-common/modules -name '*.ko' \
