...
TARGET_BOOTLOADER_BOARD_NAME := jordan_plus
...
TARGET_OMAP3 := true
#Add golbal compile option MOTO_DEFY by Seac.Cong,20120401
COMMON_GLOBAL_CFLAGS += -DTARGET_OMAP3 -DOMAP_COMPAT -DMOTOROLA_UIDS -DMOTO_DEFY -DBINDER_COMPAT
#Brian need open it on 4.1.1 start
ARCH_ARM_HAVE_TLS_REGISTER := true
#Brian need open it on 4.1.1 end
# Wifi related defines
BOARD_WLAN_DEVICE           := wl1271
WPA_SUPPLICANT_VERSION      := VER_0_6_X
BOARD_WPA_SUPPLICANT_DRIVER := CUSTOM
WIFI_DRIVER_MODULE_PATH     := "/system/lib/modules/tiwlan_drv_234.ko"
...
#Brian removed for compile error(seems no use for 4.1.1) start
#BOARD_USE_KINETO_COMPATIBILITY := true
#Brian removed for compile error end
...
TARGET_RELEASETOOL_OTA_FROM_TARGET_SCRIPT :=./device/motorola/jordan_plus/releasetools/ota_from_target_files
TARGET_PREPACKAGING_FROM_TARGET_SCRIPT :=./device/motorola/jordan_plus/releasetools/pre_packaging_system.sh
...
#BOARD_USES_HGL := true
#Brian no need build cache img start
#BOARD_CACHEIMAGE_FILE_SYSTEM_TYPE := ext3
#Brian no need build cache img end
TARGET_USERIMAGES_USE_EXT4 := false
#modefied by Jerry.Qian, 20120717, start
#COMMON_GLOBAL_CFLAGS += -DMISSING_EGL_EXTERNAL_IMAGE -DMISSING_EGL_PIXEL_FORMAT_YV12 -DMISSING_GRALLOC_BUFFERS
COMMON_GLOBAL_CFLAGS += -DMISSING_EGL_PIXEL_FORMAT_YV12
#modefied by Jerry.Qian, 20120717, end
# CM9
...
# Modified by Brian.Zhang, for MYUI-00350, 2012-01-20
#Charger
BOARD_USE_VENDOR_CHARGERMON :=true
