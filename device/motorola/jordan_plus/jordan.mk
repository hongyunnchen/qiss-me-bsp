...
PRODUCT_PACKAGES += \
	...
	charge_only_mode \
	hcitool \
	libaudioutils audio.a2dp.default audio_policy.jordan_plus \
...
# TO FIX for ICS
#PRODUCT_PACKAGES += gralloc.jordan_plus hwcomposer.jordan_plus
PRODUCT_PACKAGES += gralloc.default hwcomposer.default

#Brian add camera apk and hal module start
# ICS Camera
PRODUCT_PACKAGES += Camera camera.jordan_plus libcamera
#Brian add camera apk and hal module end
