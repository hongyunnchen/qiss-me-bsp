...
#ifndef __cam_vbq_H__
#define __cam_vbq_H__
...
extern int  cam_vbq_init(struct omapvout_device *vout);
extern void cam_vbq_destroy(struct omapvout_device *vout);
extern int  cam_vbq_buf_cnt(struct omapvout_device *vout);
