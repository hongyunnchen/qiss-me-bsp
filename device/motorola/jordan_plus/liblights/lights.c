        ...
        struct light_state_t const* state)
{
    ...
    if (!err) {
	 if(als_mode == MANUAL_SENSOR && brightness != 0)
	 	{
	 	brightness = (int)(219-(255-(float)brightness)  / (255-20) * (219-2));//official 2.3.4 manual mode max value 219,min value 2. ics 20-255
		if(brightness < 2)
			brightness = 2;
		else if(brightness > 219)
			brightness = 219;
	 	}
...
//Brian for 4.1.1 compability start
struct hw_module_t HAL_MODULE_INFO_SYM = {
//Brian for 4.1.1 compability end
