...
COMMON_GLOBAL_CFLAGS += -DTARGET_OMAP3 -DOMAP_COMPAT -DMOTOROLA_UIDS -DEGL_FOR_DEFY_FROYO -DMOTO_DEFY -DBINDER_COMPAT
#Modefied by Jerry.Qian, for MYUI-01951, 20120315
...
#Brian removed for compile error start
...
TARGET_RELEASETOOL_OTA_FROM_TARGET_SCRIPT :=./device/motorola/jordan/releasetools/ota_from_target_files
TARGET_PREPACKAGING_FROM_TARGET_SCRIPT :=./device/motorola/jordan/releasetools/pre_packaging_system.sh
...
# modefied by Jerry.Qian, 20120720, start
#COMMON_GLOBAL_CFLAGS += -DMISSING_EGL_EXTERNAL_IMAGE -DMISSING_EGL_PIXEL_FORMAT_YV12 -DMISSING_GRALLOC_BUFFERS
COMMON_GLOBAL_CFLAGS += -DMISSING_EGL_PIXEL_FORMAT_YV12
# modefied by Jerry.Qian, 20120720, end
# CM9
